...
import { useAllParentsQuery, useDeleteParentMutation } from '../../slices/ParentApiSlice';
  function Parents() {

    const [showConfirmation, setShowConfirmation] = useState(false);
    const [id, setId] =  useState()

const {data, isLoading, error, refetch} = useAllParentsQuery()
const [deleteGuardian, {isLoading:isDeleteLoaing}] = useDeleteParentMutation()
