...
const GuardianInfoForm = ({ webcamRef, formData, formErrors, handleGuadianInputChange, newGuardian,handleRegisterGuardians, handleGuardianImage,handleNext,validateStep, setRefetchs,refetchs,setFormData,setNewGuardian }) => {
  ...
  const handleRegisterGuardianss=()=>{
    setNewGuardian(true)
...
<div className="d-flex justify-content-between">
            <Button variant="primary" onClick={handleRegisterGuardianss}>
              Register Guardians
            </Button>
