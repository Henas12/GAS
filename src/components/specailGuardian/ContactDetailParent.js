...
<>     <Form >
   ...
   <Form.Group controlId="teacher_comment" className="mb-3">
    ...
    <Form.Group controlId="teacher_comment" className="mb-3">
      ...
      <Form.Control as="textarea"  name='parent_comment' required rows={3}   disabled value={datas.parent_comment}  />
    </Form.Group>
  ...
  <Button className="btn" color="secondary" onClick={()=> (navigate('/parent/home'))} >
  Go Back
   </Button></>
...
export default ContactDetailParent;
